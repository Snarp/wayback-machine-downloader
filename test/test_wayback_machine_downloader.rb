...
class WaybackMachineDownloaderTest < Minitest::Test
  ...
  def test_base_url_being_set
    assert_equal @base_url, @wayback_machine_downloader.base_url
  end

  def test_backup_name_being_set
    assert_equal @host, @wayback_machine_downloader.backup_name
  end

  def test_backup_name_being_set_when_base_url_is_domain
    @wayback_machine_downloader.base_url = @host
    assert_equal @host, @wayback_machine_downloader.backup_name
  end
  ...
  def test_all_timestamps_being_respected # FIXME
  ...
  def test_all_get_file_list_curated_size # FIXME
